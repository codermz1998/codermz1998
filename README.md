<div align="center">
  ...
  <table align="center">
    <tr>
      <td width="50%" valign="top">
        <h3>⚡ About Me</h3>
        <ul>
          <li>🛠️ Currently deep-diving into <b>Android Framework & AOSP</b>.</li>
          <li>🏍️ When not coding, I'm out on the road chasing horizons on my motorcycle.</li>
          <li>🌱 Exploring low-level system optimization and kernel-level performance.</li>
          <li>🎯 Goal: To build seamless, high-performance mobile experiences.</li>
          <li>✨ Passionate about the fusion of <b>Hardware & Software</b>.</li>
        </ul>
      </td>
      <td width="50%" valign="top">
        <h3>🛠️ Tech Stack</h3>
        ...
        <p>
          <img src="https://img.shields.io/badge/AOSP-3DDC84?style=for-the-badge&logo=android&logoColor=black" />
  ...
  <details>
    <summary align="center"><b>🎨 Developer Spirit Animal</b></summary>
    <pre align="center">
                             \\\\\\\
                            \\\\\\\\\\\\
                          \\\\\\\\\\\\\\\
